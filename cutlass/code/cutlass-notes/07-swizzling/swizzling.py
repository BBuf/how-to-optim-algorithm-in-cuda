...
sources = [os.path.join(current_dir, filename) for filename in ["swizzling.cu"]]
...
for exp in exps:
    ...
    # Case 1: MM
    kernel_output = lib.swizzling_fp16_fp16_fp16_fp32(a, b, None)
    if not ENABLE_PROF:
...
for exp in exps:
    ...
    # Case 1: MM
    kernel_output = lib.swizzling_bf16_bf16_bf16_fp32(a, b, None)
    if not ENABLE_PROF:
