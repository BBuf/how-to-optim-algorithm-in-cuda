...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/f51ef27a-be15-4a54-9279-ed95cd2c3435.png)

这节课由Nvidia的开发CUDA C++ 核心库（后面简称 CCCL）的两位工程师来讲。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/82b9f16b-d1f7-422e-9f32-8438b0676d02.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/3f8fa60a-3ceb-470b-bf08-bd53a74c3ccd.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/e306edd4-7b65-4e9a-9f29-804abf4fd163.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/d65a6f20-d1d1-4005-92a2-a4ef9b7c0216.png)

这张Slides展示了把llm.c移植为llm.cpp之后对性能和准确率没有任何影响。

接下来开始从上到下的讲解把llm.c移植到llm.cpp所做的改动：

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/4df13111-b2c7-478f-9168-91e1ae940773.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/ac4387e1-2202-4b18-8872-5bcbca847dcf.png)

这张Slides介绍了Thrust在内存管理方面对llm.c的代码移植。Thrust容器的一个直接好处是它们自动管理内存释放，这意味着我们不用担心会意外忘记释放内存。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/bfba69bd-429b-4b37-92ba-e270d4156a10.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/8f2964fd-24f8-4ae2-8085-e2330768d71a.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/36fe3ca0-a405-42b7-9ea0-b63c16d36667.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/4a47f0ac-0298-4ec1-bdc0-b822ae7d3ba9.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/d91b7e54-914e-40d6-844b-4f6160ceb574.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/0e2463a1-e48b-41a4-9da6-689cf8f6525d.png)

这里还提到我们可以通过定义`THRUST_DEVICE_SYSTEM`来指定`thrust::transform`的执行设备，这张Slides中就展示了把这个kernel的执行设备定义为CPU，并且不需要修改kernel实现代码。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/f4705275-789a-4e2b-850d-8a0f4b7ed387.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/eb8841b2-df9f-4db8-84c1-f6720ad67297.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/1c0149f8-715a-4eea-979f-7fc92926f043.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/deb3dc06-8000-4f41-98e4-07cc1f9df232.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/67d8c8be-66e7-4136-9960-7e45d165b0c5.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/3e732f33-7039-4758-954a-223d03b1983c.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/8b147082-41c2-4cd4-a091-c2eeef78f310.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/077a8951-cab2-46c2-bb81-688f9bd7d163.png)

通过`mdspan`，我们可以把一个一维数组方便的以多维的方式进行访问。


![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/f4a0e44b-80e7-4c39-b1bf-0dc9b0128546.png)

在llm.c的kernel中还采用了`__ldcs`指令进行缓存优化的内存读取，MDSpan也可以通过streaming_processor的抽象来做到。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/057b0a59-249b-4d0d-90bd-8928edb2f007.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/48eb5343-a767-404f-8158-adcb949e3bfc.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/a9b2c76a-510a-4eb3-833f-2aa38a2c3f2c.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/ae49c062-8c48-46a2-a436-d89d37fe060e.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/fe235238-aef0-4da3-8b7e-b97251d4d749.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/a2c39ded-63f5-4481-81f7-00b7cb9eb0d4.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/ff705776-61be-48d4-9acb-18f3791bec43.png)

`cuda::thread_scope_device`是给定设备内的线程集合。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/e4472d13-15ff-4246-ba0b-1ad5fb357a20.png)

`cuda::thread_scope_system`是整个系统内的线程集合。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/ca5e9247-c913-4705-b76b-03bbec4ac05f.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/192b1e90-4d7f-4367-b94c-baf71cb37e57.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/f454003f-7cc4-4bef-ae3d-275e962dfd0f.png)

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/0fb830e9-68d0-42f9-a111-810f5b6a5d4b.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/18545603-bd24-461a-bf8d-58adf66a33c8.png)
