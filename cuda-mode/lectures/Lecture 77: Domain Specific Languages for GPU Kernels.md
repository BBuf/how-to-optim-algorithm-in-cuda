...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/79a2d3af-c9ea-4c0f-845e-5e10da43d5af.png)

这里Tri Dao将介绍用于GPU kernels的特定领域的语言。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/b7201d9e-1373-4576-ac80-834d2b318677.png)

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/148022e2-4f62-4728-828a-3e4648e929f6.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/a464e467-0ab0-483e-8813-8fa333ba01b7.jpg)

为什么需要DSL？这张图用韦恩图说明了原因：算法研究追求更好的模型，硬件优化追求更好的扩展性，DSL正好处在两者交集，既能保证研究生产力又能充分利用硬件。另外一个bonus是DSL + 好的抽象让LLM更容易生成高效的GPU kernels。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/06b2e9f8-7811-4ec2-82de-ab424c681d3e.png)

我会讨论一系列DSL以及基于它们开发的softmax和gemm以及attn的perf结果。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/f34720bf-cee8-464e-8f08-78f7bf792cf4.jpg)

首先我认为PyTorch是第一个DSL，通过PyTorch编写程序让代码变成在GPU上运行的一系列kernels。然后PyTorch 2.x利用Dynamo可以捕获你的程序让它通过Triton去编译执行。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/b8313bed-512d-4a1f-a9a6-b6b8638dafbc.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/d8d43246-ad2b-4056-808f-f9c30b9d63aa.jpg)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/58d20531-ee29-4baa-bf31-5d5317dddfa4.jpg)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/d294727e-a857-4444-a683-7b57eaae7cbc.jpg)

其他值得关注的DSL工具：ThunderKittens（斯坦福开发，简单快速的AI kernel框架）、TileLang（基于tile的GPU编程抽象）、Mojo（结合Python易用性和系统级性能）、Mosaic GPU（另一种GPU编程抽象）。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/776b9a31-d0d0-4b00-ae9d-f0dff7855638.jpg)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/3dca4df8-5160-4b55-9ff1-7a1746e44354.png)

这里选了一个Softmax的例子来看不同DSL的实现，首先是Torch Compile。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/e395cc3b-26bd-4b0a-9d64-dfde8495cbbc.png)

Liger Kernel的SoftMax Triton实现，代码简洁。使用`@triton.jit`装饰器，核心逻辑：获取行ID和偏移量→加载数据并处理边界→计算最大值（数值稳定）→计算exp和归一化→输出结果。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/b84808ee-28d3-43f1-b351-006e9283fd8f.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/a0276594-9aca-40c4-89e3-615d6d7e950f.jpg)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/33f419e7-87ee-4978-8383-aa2502c9638a.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/f2d51623-f30c-4b43-aa8a-72a059e92d7a.jpg)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/640f7f6b-e75c-4186-a75a-5b9305215395.jpg)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/ebe10beb-206d-4d02-80de-77a6591e1215.jpg)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/e3ad0771-9380-428b-9261-47ff9028676c.png)

Cute-DSL Softmax的完整归约层次结构。代码流程：加载数据到寄存器→线程归约→warp归约→条件判断（如果每行有多个warp）→根据集群配置选择块归约或集群归约。这种自适应设计能根据不同GPU配置选择最优归约策略。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/2554df27-ec72-4736-840f-7d9700b0b0ec.jpg)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/6e718115-6c21-4f24-84b5-3342f36a2db6.png)

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/c9e58056-6ae3-487f-9914-08fe57c8a56c.jpg)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/ddedfcb7-e405-4be4-9d88-278384101105.jpg)

Ping-Pong Schedule的介绍可以看PyTorch的blog: https://pytorch.org/blog/cutlass-ping-pong-gemm-kernel/

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/11bc3899-06a3-4f5e-844a-395860b96ac5.jpg)

在Blackwell上cuBlas的性能暂时比基于Cute-DSL的要好，不过这个3%的gap应该会被解决。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/b51c2c69-6c26-4677-acb8-2393eb0ff9a8.png)

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/bfbaf547-a3e7-4d9d-9f9f-8bec341afabc.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/19160574-8180-4e22-a8f8-7bd0872f01b7.jpg)

这张Slides展示了基于Cute-DSL的FA4相比于CUDNN实现的Flash Attention的优势。


![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/563b35a3-0cd4-4348-b30f-3103e65bfc34.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/bb3cee01-1591-44d0-8881-3cab3e4deac3.png)
