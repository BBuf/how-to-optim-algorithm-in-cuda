...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/a4210d81-678e-4203-a48c-1e04c565f683.jpg)

这张图片展示了NVIDIA AI技术开放日2025初夏活动的演讲封面，主题为"GPU内存系统演进：最大化带宽利用与延迟隐藏的技术路径"。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/67ff1ba8-7e20-402b-a7ef-cb9ca5ba2103.png)


这张图片展示了GPU内存系统的技术架构和演进路径，是这个演讲的目录。包含硬件发展趋势，理解内存带宽，最大化内存带宽以及为小尺寸解决隐藏延迟。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/3ec473db-da40-425b-a088-8f81aa6d8dd3.png)


这张图片展示了GPU硬件发展的趋势分析，包含了不同代GPU架构的内存带宽对比、SMs数量对比以及每个SM的内存带宽对比。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/13ac86b8-0848-49b9-b308-a972ce05b983.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/a8498248-d77a-48e5-8bbd-245ea39c413b.png)

理解内存带宽，看一下Little's Law。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/408be90c-2c8a-4f00-b239-86a9a9ca1451.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/a66f72e0-2603-450b-9533-fd2ab2516e67.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/1ad4fc18-ba42-4864-8426-09b6a39a41e2.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/04c168a6-4f35-450a-9cbd-085c5c4d5088.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/22fe1b99-8dbb-4bba-ab85-6619a0fcdcb2.png)

如果我们把每个线程的负载从2改到3，我们可以看到kernel的带宽利用率就增加了，但是这里改变了问题，我们应该如何通用的去解决这个问题呢？

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/4095e363-f578-43dc-ab46-6641a0d0ed23.png)

如何增加in-fight数据和带宽？

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/7e68d828-9b3a-470f-8be6-6ae3201731b3.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/2940fc61-74c4-4e6c-ba54-df8b0883df0f.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/a1e8663e-a149-4d50-970b-f27db844174e.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/bad03506-80a9-4591-83ea-6d66a386039a.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/d1b33d68-b00a-4b96-a494-513e8278899c.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/1eccc616-02f2-4d15-b353-7b975382d3ab.png)

增加ILP（指令级并行/展开）和DLP（数据级并行/向量化）会增加寄存器压力。右侧图表显示了不同GPU世代（H100、H200、GB200-NVL）在寄存器使用率与峰值带宽之间的关系，特别指出在B200上达到SOL带宽需要使用40%的寄存器。

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/0d9f6ec6-1817-4bb9-8e47-3c4359863b6e.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/f9a82b94-0ae3-4ebf-9267-a59f871c90dd.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/c66e1e0c-728a-40ed-bdb1-d7ddd0ba6a5a.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/d860aedb-5098-4baf-94b9-47ecd891e2c4.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/87bbc65e-f8b1-4399-829b-fc7325521859.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/fa842750-061c-4882-aea6-91debf201b83.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/4436e812-84a9-41a6-abc4-798b7fd9d772.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/686f239b-d79e-4006-854b-b6e40978bf0b.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/023a4b9c-3043-4144-95a7-2d32620755c2.png)

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/683ae458-b542-4044-a27b-cbd20a66576a.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/c934928d-4588-42c7-802e-7de623bf05ee.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/7a93c4af-fa90-49ad-aade-bda882bd000c.png)

![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/755dfc8e-1742-4800-b4e4-429b669fe95d.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/7423ee1f-f882-49f1-8d2a-786d9e73ae1a.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/c7f6e246-eb67-4fb6-a3a3-fc6ea6d51ebb.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/759c1895-ba10-423a-8698-dba1ac7050e6.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-1/3d0af22c-76cb-4a85-be03-bc4826af0bf9.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/960dc7c7-cae6-4080-a7cc-0d12232e071d.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/724978b0-6bac-480c-b145-f3264977fb7c.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-3/e6fecb77-d026-409b-b357-b125d225de30.png)
...
![](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/releases/download/mdnice-assets-2026-08-05-2/6f068174-c202-42ce-b74a-16a2810b79a7.png)
