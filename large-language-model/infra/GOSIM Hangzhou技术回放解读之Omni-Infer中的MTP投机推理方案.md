> 这篇按 slides 顺序梳理 Omni-Infer 里的 MTP 投机推理实现。图片保留为线上链接；涉及技术实现的部分只讨论公开代码和公开文档。
...
LMSYS 的 MTP blog 可以先当成通用版流程图读，再回到 Omni-Infer 的 NPU 适配里看差异：

![](https://files.mdnice.com/user/59/babf8956-7a0f-4d17-8155-3cb8df8eff6b.png)
...
![](https://files.mdnice.com/user/59/490a2254-b26e-4d18-8221-6928fbdbbf08.png)

标题页不展开。这里的重点是 Ascend NPU 上的投机推理：Decode 阶段单 token 迭代很容易受带宽和同步开销限制，MTP 一次预测多个后续 token，目标是把串行 decode 步合并成更适合 NPU 执行的大步。

### Slide 2：Decode memory-bound 与投机推理

![](https://files.mdnice.com/user/59/3677c274-d289-4776-b82a-e8be40db7587.png)
...
![](https://files.mdnice.com/user/59/b964ac17-6192-4b8d-a8ad-4dd3ea8f0a85.png)
...
![](https://files.mdnice.com/user/59/f99b7bd4-d34f-49ce-ab86-a9047bcb5586.png)

这页强调 hidden state 的选择。MTP 下一步输入不能随便取最后一个位置，而要取“验证后最后接受 token”的状态；否则 draft 会沿着错误前缀继续猜。

### Slide 5：CPU-NPU 同步气泡

![](https://files.mdnice.com/user/59/f39884bc-aa4b-4bcb-900b-d0ac53487f70.png)
...
![](https://files.mdnice.com/user/59/54c33693-a707-46c9-b300-c0b10229a8b3.png)

Omni-Infer 支持 DeepSeek V3 MTP、Qwen2 EAGLE/EAGLE3、Pangu Ultra MoE MTP 等。它不是单个模型 patch，而是把 speculative method 做成推理引擎能力。

### Slide 7：采样和验证策略

![](https://files.mdnice.com/user/59/622bc963-b16a-4b82-a59b-5d67f37f91a6.png)
...
![](https://files.mdnice.com/user/59/0363beaf-1588-4800-a249-9802e33cde27.png)
...
![](https://files.mdnice.com/user/59/577b633a-96e7-4ab5-a718-bcd3cb88d623.png)
...
![](https://files.mdnice.com/user/59/091f3dcf-8e5d-417e-bea5-ed12ecd490e5.png)
...
![](https://files.mdnice.com/user/59/efaf206e-8fd6-45d1-b9d9-cdfe7d033426.png)

Adaptive speculation 根据接受情况动态调整猜测长度。接受率高就多猜，接受率低就少猜，避免在困难 prompt 上浪费 MTP 计算。

### Slide 12：MLA 中 MTP 的 KV 复用优化

![](https://files.mdnice.com/user/59/4b2000fc-edde-4ec8-84d9-828df2b6bb8a.png)

MLA 优化页很硬核：MTP 会产生 `m+1` 个 Q，但它们共享 K。优化目标是减少重复 K 加载，让多个 Q 尽量留在 L1/cache 里，降低 HBM 访问。

### Slide 13：Omni-Infer 仓库和接入方式

![](https://files.mdnice.com/user/59/2d337110-3710-4ea7-a3bb-d0c18d3b97e8.png)
...
![](https://files.mdnice.com/user/59/1bc90c26-3291-4b45-8ccc-b9755bb3ef85.png)
