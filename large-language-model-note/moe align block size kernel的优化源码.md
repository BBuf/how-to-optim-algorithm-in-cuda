...
这篇blog回顾一下sgl-kernel中moe align block size kernel的优化过程(https://github.com/sgl-project/sglang/blob/main/sgl-kernel/csrc/moe/moe_align_kernel.cu)，这里只关注代码部分，benchmark来说的话0x4的版本和0x5的版本测出来非常接近，然后0x1->0x2->0x3->0x4是在sgl-kernel中的优化过程。
...
# 0x2. Fuse sorted_token_ids padding to moe_align_block_size kernel 

对应：https://github.com/sgl-project/sglang/pull/7437
...
# 0x4. opt moe align block kernel by block/warp scan algorithm
...
# 0x5. 赤兔框架在BaseLine基础上做的改进


代码：https://github.com/thu-pacman/chitu/blob/public-main/csrc/cuda/moe/moe_align_kernel.cu
...
# 0x6. 把赤兔框架的优化应用到0x4节的kernel中（未来工作, 需要改代码）
